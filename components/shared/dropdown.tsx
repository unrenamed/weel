            ...
            <div className="max-w-md p-2">
              {items.map(({ value, display }) => (
                <button
                  ...
                  className="flex w-full items-center justify-between px-2 py-2 rounded-md hover:bg-gray-100 active:bg-gray-100 focus-visible:bg-gray-100 hover:dark:bg-neutral-700 active:dark:bg-neutral-700 focus-visible:dark:bg-neutral-700 outline-0"
                >
  ...
  return (
    <DropdownMenuPrimitive.Root onOpenChange={setOpen}>
      ...
      <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content className="animate-slide-up-fade z-50 items-center rounded-md border border-gray-200 bg-white dark:bg-neutral-900 dark:border-neutral-700 drop-shadow-lg sm:block mt-2">
