...
export default function ButtonDropdown({ content, icon, text }: Props) {
  ...
  return (
    <DropdownMenu content={content} onOpenChange={setOpen}>
      <button className="flex items-center justify-between rounded-md shadow transition-all active:scale-95 px-3 py-2.5 bg-white hover:shadow-md w-full xs:w-48">
